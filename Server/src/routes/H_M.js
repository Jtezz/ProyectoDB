...
router.get('/admin/bm_h_m/:ID',(req,res) => {
    const {ID}=req.params;
    const query=`select com.ID_HM,hora.idHora,hora.bloque,hora.Fecha,medico.Nombre from medico,hora,(select * from horario_medico where horario_medico.ID_MED=?) AS com where com.ID_H=hora.idHora and com.ID_MED=medico.idMedico;`;
